...
namespace Bigio.BigArray.Managers
{
    ...
    public static class DefaultValuesManager
    {
        ...
        /// <summary>
        /// Through this field you can set or get global value of <see cref="DefaultBlockSize"/>.
        /// All new objects will have this size of <see cref="DefaultBlockSize"/>.
        /// </summary>
        ...
        /// <summary>
        /// Through this field you can set or get global value of <see cref="MaxBlockSize"/>.
        /// All new objects will have this value of <see cref="MaxBlockSize"/> field.
        /// </summary>
        ...
        /// <summary>
        /// Internal value of <see cref="DefaultBlockSize"/>. Dont use it out of <see cref="DefaultBlockSize"/> field.
        /// </summary>
        private static int _defaultBlockSize;

        /// <summary>
        /// Internal value of <see cref="MaxBlockSize"/>. Dont use it out of <see cref="MaxBlockSize"/> field.
        /// </summary>
